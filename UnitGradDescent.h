...
public:
	...
	GradDescent(const GradDescent&) = delete;
	GradDescent(GradDescent&&) = delete;

	GradDescent& operator=(const GradDescent&) = delete;
	GradDescent& operator=(GradDescent&&) = delete;
